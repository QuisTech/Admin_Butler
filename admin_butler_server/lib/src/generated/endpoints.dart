      ...
      methodConnectors: {
        'hello': _i1.MethodConnector(
          ...
          call:
              ...
              ) async => (endpoints['document'] as _i2.DocumentEndpoint).hello(
                session,
                params['name'],
              ),
        ),
        'scanDocument': _i1.MethodConnector(
          name: 'scanDocument',
          params: {
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['document'] as _i2.DocumentEndpoint).scanDocument(
                    session,
                    params['imageBase64'],
                  ),
        ),
        'getDocuments': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['document'] as _i2.DocumentEndpoint)
